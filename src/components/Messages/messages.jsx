...
const Messages = (props) =>{
    return(
        <div className={mes_style.wrapper}>
            ...
            <Friend photo="https://i.pinimg.com/736x/6e/ef/37/6eef3770e8aaf4a22e2e28944e0f0478.jpg" name="Walter White"/>
            <Friend photo="https://koshka.top/uploads/posts/2021-12/1640328596_1-koshka-top-p-kota-na-avatarku-1.jpg" name="Dima"/>
            <Friend photo="https://avatars.mds.yandex.net/i?id=5596d24cb431856c74aa0a15a051ab1ee75b7acb-4612849-images-thumbs&n=13" name="Jessie Pinkman" />
            </div>
